...
Hyperion.Themes = {
    ...
    Neko = {
        ...
        -- Warm dark with subtle blush undertone — panels sit nicely over the cream/sage image
        GradientStops = {
            {0,    Color3.fromRGB(10,  6,   8)},
            {0.12, Color3.fromRGB(22,  12,  16)},
            {0.28, Color3.fromRGB(38,  18,  26)},
            {0.42, Color3.fromRGB(48,  22,  32)},
            {0.55, Color3.fromRGB(40,  18,  28)},
            {0.7,  Color3.fromRGB(26,  12,  18)},
            {0.86, Color3.fromRGB(15,  7,   11)},
            {1,    Color3.fromRGB(10,  6,   8)},
        },
        ...
        AccentSub    = Color3.fromRGB(168, 118, 205),
        Background   = Color3.fromRGB(10,  6,   8),
        Surface      = Color3.fromRGB(28,  16,  22),
        SurfaceLight = Color3.fromRGB(45,  26,  35),
        SurfaceHover = Color3.fromRGB(62,  36,  48),
        SurfaceActive= Color3.fromRGB(78,  46,  60),
        Sidebar      = Color3.fromRGB(16,  9,   13),
        SidebarActive= Color3.fromRGB(52,  30,  42),
        Text         = Color3.fromRGB(250, 242, 235),
        TextDim      = Color3.fromRGB(200, 182, 172),
        TextMuted    = Color3.fromRGB(118, 98,  108),
        Border       = Color3.fromRGB(88,  45,  65),
        BorderLight  = Color3.fromRGB(135, 72,  100),
        ToggleOff    = Color3.fromRGB(48,  22,  35),
        SliderBg     = Color3.fromRGB(28,  12,  20),
        InputBg      = Color3.fromRGB(16,  8,   12),
    },
}
