...
Hyperion.Themes = {
    ...
    Bunny = {
        ...
        ParticleStyle = "paws",
        GradientStops = {
            {0,    Color3.fromRGB(255, 240, 247)},
            {0.5,  Color3.fromRGB(255, 214, 232)},
            {1,    Color3.fromRGB(255, 240, 247)},
        },
        Accent       = Color3.fromRGB(255, 128, 178),
        AccentDark   = Color3.fromRGB(228, 96, 150),
        AccentLight  = Color3.fromRGB(255, 168, 204),
        AccentGlow   = Color3.fromRGB(255, 150, 192),
        AccentSub    = Color3.fromRGB(235, 118, 165),
        Background   = Color3.fromRGB(255, 242, 248),
        Surface      = Color3.fromRGB(255, 249, 252),
        SurfaceLight = Color3.fromRGB(252, 236, 243),
        SurfaceHover = Color3.fromRGB(250, 228, 238),
        SurfaceActive= Color3.fromRGB(248, 219, 231),
        Sidebar      = Color3.fromRGB(255, 246, 250),
        SidebarActive= Color3.fromRGB(251, 232, 240),
        Text         = Color3.fromRGB(74, 46, 60),
        TextDim      = Color3.fromRGB(150, 108, 128),
        TextMuted    = Color3.fromRGB(196, 160, 176),
        Border       = Color3.fromRGB(242, 212, 226),
        BorderLight  = Color3.fromRGB(248, 224, 235),
        ToggleOff    = Color3.fromRGB(240, 214, 226),
        SliderBg     = Color3.fromRGB(246, 224, 235),
        InputBg      = Color3.fromRGB(255, 249, 252),
    },
    Matcha = {
        Logo         = nil,
        Animated     = true,
    ...
    Cyberpunk = {
        Logo         = nil,
        Animated     = true,
        StarColor    = Color3.fromRGB(0, 240, 255),
        ParticleStyle = "gridlines",
        GradientStops = {
            {0,    Color3.fromRGB(8, 4, 16)},
            {0.3,  Color3.fromRGB(26, 8, 38)},
            {0.5,  Color3.fromRGB(48, 12, 60)},
            {0.7,  Color3.fromRGB(26, 8, 38)},
            {1,    Color3.fromRGB(8, 4, 16)},
        },
        Accent       = Color3.fromRGB(255, 40, 170),
        AccentDark   = Color3.fromRGB(200, 25, 130),
        AccentLight  = Color3.fromRGB(0, 230, 255),
        AccentGlow   = Color3.fromRGB(255, 70, 190),
        AccentSub    = Color3.fromRGB(0, 190, 220),
        Background   = Color3.fromRGB(8, 4, 16),
        Surface      = Color3.fromRGB(16, 9, 26),
        SurfaceLight = Color3.fromRGB(26, 15, 40),
        SurfaceHover = Color3.fromRGB(36, 20, 54),
        SurfaceActive= Color3.fromRGB(46, 26, 66),
        Sidebar      = Color3.fromRGB(11, 6, 20),
        SidebarActive= Color3.fromRGB(28, 16, 44),
        Text         = Color3.fromRGB(240, 230, 250),
        TextDim      = Color3.fromRGB(180, 140, 200),
        TextMuted    = Color3.fromRGB(110, 80, 130),
        Border       = Color3.fromRGB(48, 24, 66),
        BorderLight  = Color3.fromRGB(70, 36, 92),
        ToggleOff    = Color3.fromRGB(44, 24, 60),
        SliderBg     = Color3.fromRGB(30, 16, 44),
        InputBg      = Color3.fromRGB(10, 5, 18),
    },
    Inferno = {
        Logo         = nil,
        Animated     = true,
        StarColor    = Color3.fromRGB(255, 150, 50),
        ParticleStyle = "embers",
        GradientStops = {
            {0,    Color3.fromRGB(16, 5, 3)},
            {0.3,  Color3.fromRGB(48, 12, 6)},
            {0.5,  Color3.fromRGB(96, 26, 8)},
            {0.7,  Color3.fromRGB(48, 12, 6)},
            {1,    Color3.fromRGB(16, 5, 3)},
        },
        Accent       = Color3.fromRGB(255, 110, 40),
        AccentDark   = Color3.fromRGB(205, 70, 20),
        AccentLight  = Color3.fromRGB(255, 165, 70),
        AccentGlow   = Color3.fromRGB(255, 130, 50),
        AccentSub    = Color3.fromRGB(200, 60, 30),
        Background   = Color3.fromRGB(16, 5, 3),
        Surface      = Color3.fromRGB(28, 11, 7),
        SurfaceLight = Color3.fromRGB(42, 18, 11),
        SurfaceHover = Color3.fromRGB(56, 25, 14),
        SurfaceActive= Color3.fromRGB(68, 31, 17),
        Sidebar      = Color3.fromRGB(20, 8, 5),
        SidebarActive= Color3.fromRGB(46, 20, 12),
        Text         = Color3.fromRGB(250, 236, 224),
        TextDim      = Color3.fromRGB(196, 150, 120),
        TextMuted    = Color3.fromRGB(128, 90, 66),
        Border       = Color3.fromRGB(60, 28, 16),
        BorderLight  = Color3.fromRGB(84, 40, 22),
        ToggleOff    = Color3.fromRGB(56, 26, 15),
        SliderBg     = Color3.fromRGB(40, 18, 10),
        InputBg      = Color3.fromRGB(18, 7, 4),
    },
    Arctic = {
        Logo         = nil,
        Animated     = true,
        StarColor    = Color3.fromRGB(220, 245, 255),
        ParticleStyle = "snowflakes",
        GradientStops = {
            {0,    Color3.fromRGB(8, 14, 22)},
            {0.3,  Color3.fromRGB(16, 30, 46)},
            {0.5,  Color3.fromRGB(28, 52, 78)},
            {0.7,  Color3.fromRGB(16, 30, 46)},
            {1,    Color3.fromRGB(8, 14, 22)},
        },
        Accent       = Color3.fromRGB(120, 200, 255),
        AccentDark   = Color3.fromRGB(80, 155, 215),
        AccentLight  = Color3.fromRGB(175, 225, 255),
        AccentGlow   = Color3.fromRGB(150, 215, 255),
        AccentSub    = Color3.fromRGB(90, 160, 210),
        Background   = Color3.fromRGB(8, 14, 22),
        Surface      = Color3.fromRGB(14, 22, 34),
        SurfaceLight = Color3.fromRGB(22, 33, 50),
        SurfaceHover = Color3.fromRGB(30, 44, 66),
        SurfaceActive= Color3.fromRGB(38, 54, 80),
        Sidebar      = Color3.fromRGB(10, 17, 27),
        SidebarActive= Color3.fromRGB(22, 35, 54),
        Text         = Color3.fromRGB(228, 240, 252),
        TextDim      = Color3.fromRGB(150, 178, 205),
        TextMuted    = Color3.fromRGB(80, 105, 132),
        Border       = Color3.fromRGB(30, 48, 70),
        BorderLight  = Color3.fromRGB(44, 66, 94),
        ToggleOff    = Color3.fromRGB(28, 44, 64),
        SliderBg     = Color3.fromRGB(20, 33, 50),
        InputBg      = Color3.fromRGB(9, 15, 24),
    },
    ["Royal Gold"] = {
        Logo         = nil,
        Animated     = true,
