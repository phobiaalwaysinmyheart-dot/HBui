...
Hyperion.Themes = {
    ...
    Neko = {
        ...
        StarColors    = {
            Color3.fromRGB(238, 155, 185),  -- sakura pink
            Color3.fromRGB(248, 215, 228),  -- soft blush
            Color3.fromRGB(195, 155, 220),  -- lilac
            Color3.fromRGB(252, 242, 235),  -- warm cream
        },
        ParticleStyle = "paws",
        TitleGradient = {
            ColorSequenceKeypoint.new(0,   Color3.fromRGB(238, 175, 155)),
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 248, 238)),
            ColorSequenceKeypoint.new(1,   Color3.fromRGB(215, 165, 190)),
        },
        LogoGradient = {
            ColorSequenceKeypoint.new(0,   Color3.fromRGB(218, 138, 170)),
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(242, 200, 218)),
            ColorSequenceKeypoint.new(1,   Color3.fromRGB(178, 118, 155)),
        },
        GradientStops = {
            {0,    Color3.fromRGB(10, 10,  9)},
            {0.12, Color3.fromRGB(20, 18, 15)},
            {0.28, Color3.fromRGB(32, 28, 22)},
            {0.42, Color3.fromRGB(38, 34, 26)},
            {0.55, Color3.fromRGB(32, 28, 22)},
            {0.7,  Color3.fromRGB(22, 19, 15)},
            {0.86, Color3.fromRGB(14, 12,  9)},
            {1,    Color3.fromRGB(10, 10,  9)},
        },
        Accent       = Color3.fromRGB(218, 128, 165),
        AccentDark   = Color3.fromRGB(168, 85,  118),
        AccentLight  = Color3.fromRGB(240, 178, 205),
        AccentGlow   = Color3.fromRGB(228, 148, 180),
        AccentSub    = Color3.fromRGB(185, 148, 118),
        Background   = Color3.fromRGB(10,  10,  9),
        Surface      = Color3.fromRGB(26,  22,  18),
        SurfaceLight = Color3.fromRGB(40,  35,  28),
        SurfaceHover = Color3.fromRGB(55,  48,  38),
        SurfaceActive= Color3.fromRGB(70,  60,  48),
        Sidebar      = Color3.fromRGB(16,  13,  10),
        SidebarActive= Color3.fromRGB(46,  40,  32),
        Text         = Color3.fromRGB(250, 242, 235),
        TextDim      = Color3.fromRGB(198, 185, 168),
        TextMuted    = Color3.fromRGB(120, 108,  92),
        Border       = Color3.fromRGB(72,  62,  50),
        BorderLight  = Color3.fromRGB(108, 94,  76),
        ToggleOff    = Color3.fromRGB(40,  34,  26),
        SliderBg     = Color3.fromRGB(22,  18,  14),
        InputBg      = Color3.fromRGB(14,  11,   8),
    },
}
